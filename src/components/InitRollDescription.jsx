...
const InitRollDescription = ( {rep1, rep2, roll1, roll2, pass1, pass2, activePlayer} ) => {
  let textlog;
  if (pass1 > pass2) {
    ...
    if (rep1 > rep2) {
      ...
      textlog += `Both leaders' reps are the same, so the moving side (player ${activePlayer}) becomes active. `;
    }
  }
